...
radosgw-admin realm pull --url=http://zgp1z1.ecloud.today:443  --access-key=admin --secret=admin
...
radosgw-admin period update --commit --url=http://zgp1z1.ecloud.today:443  --rgw-realm=default   --access-key=admin --secret=admin
