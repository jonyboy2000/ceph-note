...
class S3Auth(AuthBase):
    ...
    special_params = [
        ...
        'notification', 'cors', 'syncing','symlink'
    ]
    ...
    def __call__(self, r):
        ...
        r.headers['Authorization'] = 'OSS %s:%s' % (self.access_key, signature)
        return r
...
url = 'http://iosonesttest.oss-cn-shanghai.aliyuncs.com/1.txt?symlink'
# response = requests.put(url, auth=S3Auth(access_key, secret_key,service_url='oss-cn-shanghai.aliyuncs.com'),data = "1234567890")
