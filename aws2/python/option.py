...
access_key = 'yly'
secret_key = 'yly'
headers = {'origin': 'http://www.qq.com','Access-Control-Request-Method': 'GET'}
url = 'http://192.168.153.152/bucket01/ceph-rest-api.service'
response = requests.options(url, auth=S3Auth(access_key, secret_key,service_url='192.168.163.152'),headers = headers)
...
s3cmd setcors cors.xml s3://yuliyangtest1
